...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{polyssh runs command on multiple remote servers via ssh with friendly TUI.}
  spec.description   = %q{polyssh runs command on multiple remote servers via ssh with friendly TUI.}
